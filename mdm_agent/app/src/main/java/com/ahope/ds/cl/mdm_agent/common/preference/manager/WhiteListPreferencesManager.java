...
import com.ahope.ds.cl.mdm_agent.common.preference.config.WhitelistPreferencesConfig;
...
public class WhiteListPreferencesManager {
    private static final String TAG = WhiteListPreferencesManager.class.getSimpleName();
    private static WhiteListPreferencesManager sInstance;
    private final SharedPreferences mPref;

    private WhiteListPreferencesManager(Context context) {
        mPref = context.getSharedPreferences(WhitelistPreferencesConfig.PERF_NAME, Context.MODE_PRIVATE);
    }

    public static synchronized void initializeInstance(Context context) {
        if (sInstance == null) {
            sInstance = new WhiteListPreferencesManager(context);
        }
    }

    public static synchronized WhiteListPreferencesManager getInstance() {
        if (sInstance == null) {
           return null;
        }
        return sInstance;
